...
- Awards & Prestigious Recognitions: 
  - **Star of the Month Award (July 10, 2026 - TCS)**: Awarded by Manager for automating the complete vulnerability fix cycle from a manual process (taking a full day) to an automated one (15 minutes maximum). The pipeline automatically updates the main branch, deploys to all AWS environments, validates the full infrastructure, and performs an auto-rollback on error requiring manual approval. ![Star of the Month](/achievements/star-of-the-month.jpg)
  - **Emerging AI Champion 2026 (August 25, 2026 - TCS Aviation Client)**: Honored out of the entire account by global leaders and customers during discussions on future roadmaps and how offshore/onshore teams tackle the hardest engineering bottlenecks. ![Emerging AI Champion](/achievements/emerging-ai-champion.jpg)
  - **AI Fridays Season 2 Certificate (July 24, 2026 - TCS)**: Certificate of achievement for completing the AI innovation challenge during the TCS AI Friday Hackathon. ![AI Fridays Season 2](/achievements/ai-fridays-s2.png)
